package com.example.testingone.expandablelists;
...
public class ExpandableListViews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expandable_list_views);
